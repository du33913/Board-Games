...
public class SecretSpotWidget extends JPanel implements ActionListener, SpotListener {
	...
	private void resetGame() {
		...
		_message.setText("Welcome to the Secret Spot Game. Blue to play");
	}
